...
{
    wp_enqueue_style('blankslate-style', get_stylesheet_uri('style.css'));
...
<style type="text/css">
    body.login div#login h1 a {
        background-image: url(http://localhost/wordpress%202/wordpress/wp-content/uploads/2023/03/Dicky-Code.png);
        padding-top: 30px;
    }
</style>
<?php
} add_action('login_enqueue_scripts', 'pic_login');
